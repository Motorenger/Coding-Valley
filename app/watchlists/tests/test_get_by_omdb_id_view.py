...
def test_get_with_correct_imdb_id_and_incorrect_type_query_params(api_client):
    # given
    imdb_id = "tt0944947"
    type = "incorrect_type"
    # when
...
def test_get_with_incorrect_imdb_id_and_correct_type_query_params(api_client):
    # given
